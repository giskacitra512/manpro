...
<head>
    ...
    <title>Admin Dashboard - BiomediHub</title>
        ...
        <header class="bg-white shadow-sm border-b border-gray-200 px-8 py-6">
            <div class="flex justify-between items-center">
                <div>
                    ...
                    <p class="text-gray-600 mt-1">Kelola materi kuliah dan sistem BiomediHub</p>
                </div>
            </div>
        </header>
        ...
        <main class="p-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                ...
                <div class="bg-white rounded-xl shadow-md p-6 border-l-4 border-beige-600">
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-gray-600 text-sm font-medium">Semester Aktif</p>
                            <p class="text-3xl font-bold text-gray-800 mt-2">{{ $stats['total_semesters'] }}</p>
                        </div>
                ...
                <div class="bg-white rounded-xl shadow-md p-6 border-l-4 border-green-600">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-3xl font-bold text-green-600 mt-2">Aktif</p>
                        </div>
            ...
            <div class="bg-white rounded-xl shadow-md p-6 mb-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <a href="#" class="flex items-center space-x-3 p-4 border-2 border-dashed border-gray-300 rounded-lg hover:border-blue-600 hover:bg-blue-50 transition-all group">
                    ...
                    <table class="w-full">
                        ...
                        <tbody class="divide-y divide-gray-200">
                            ...
                            <tr class="hover:bg-beige-50 transition-colors">
                                ...
                                <td class="px-6 py-4 text-gray-600">{{ $material->mata_kuliah }}</td>
                                <td class="px-6 py-4">
